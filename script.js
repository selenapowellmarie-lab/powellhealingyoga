...
const languageData = {
  en: {
    ...
    services: {
      ...
      list: [
        {
          title: "Hatha Yoga",
          text: "Gentle postures and breathing techniques for relaxation.",
        },
        {
          title: "Vinyasa Flow",
          text: "Dynamic sequences that connect movement with breath.",
        },
        {
          title: "Meditation Sessions",
          text: "Guided meditation to calm the mind and find focus.",
        },
        {
          title: "Private Lessons",
          text: "One-on-one sessions tailored to your personal goals.",
        },
        {
          title: "Workshops",
          text: "Special events to deepen your practice and knowledge.",
        },
        {
          title: "Corporate Wellness",
          text: "Yoga and mindfulness programs for workplaces.",
        },
      ],
    },
    schedule: {
    ...
    reasons: {
      ...
      list: [
        ...
        },
        {
          ...
          text: "Group, private, and online sessions available.",
        },
        {
          title: "Holistic Approach",
          text: "Focus on mind, body, and spirit.",
        },
        {
          title: "Community Support",
          text: "Be part of a welcoming and supportive yoga family.",
        },
        {
          title: "Wellness Retreats",
          text: "Seasonal retreats to rejuvenate your soul.",
        },
      ],
    },
  },
  jp: {
    title: "パウエルヒーリングヨガ",
    siteName: "パウエルヒーリングヨガ",
    welcomeModal: {
      heading: "パウエルヒーリングヨガへようこそ",
      text: "ニューヨークと東京で行うヨガと瞑想のクラスで心の平和を見つけましょう。",
      button: "始める",
    },
    headerNav: {
      home: "ホーム",
    ...
    services: {
      ...
      list: [
        {
          title: "ハタヨガ",
          text: "リラックスのための穏やかなポーズと呼吸法。",
        },
        {
          title: "ヴィンヤサフロー",
          text: "呼吸と動きをつなぐダイナミックなシークエンス。",
        },
        {
          title: "瞑想セッション",
          text: "心を落ち着け集中するためのガイド付き瞑想。",
        },
        {
          title: "プライベートレッスン",
          text: "個人の目標に合わせたマンツーマン指導。",
        },
        { title: "ワークショップ", text: "練習や知識を深める特別イベント。" },
        {
          title: "法人向けウェルネス",
          text: "職場のためのヨガとマインドフルネスプログラム。",
        },
      ],
    },
    schedule: {
      ...
      emergency: {
        title: "リトリート・特別イベント",
        text: "ニューヨークと東京で開催される季節ごとのリトリートやワークショップ",
      },
    },
    ...
    footer: {
      ...
      copyright: "© 2025 パウエルヒーリングヨガ。無断転載禁止。",
    },
    reasons: {
      heading: "私たちを選ぶ理由",
      list: [
        ...
        {
          title: "落ち着いたスタジオ",
          text: "ニューヨークと東京の静かな空間で練習。",
        },
        {
          title: "柔軟な選択肢",
          text: "グループ、個人、オンラインセッションをご用意。",
        },
        {
          title: "ホリスティックなアプローチ",
          text: "心・体・魂に焦点を当てます。",
        ...
        {
          title: "コミュニティサポート",
          text: "温かく支え合うヨガ仲間とつながりましょう。",
        },
        {
          title: "ウェルネスリトリート",
          text: "心をリフレッシュする季節ごとのリトリート。",
        },
      ],
    },
  },
...
function setLanguage(lang) {
  ...
  if (aboutBusinessHeading)
    aboutBusinessHeading.textContent = data.about.businessAddress;
  ...
  if (scheduleCards[0]) {
    scheduleCards[0].querySelector("h3").textContent =
      data.schedule.regular.title;
  ...
  if (scheduleCards[1]) {
    scheduleCards[1].querySelector("h3").textContent =
      data.schedule.emergency.title;
    scheduleCards[1].querySelector("p").textContent =
      data.schedule.emergency.text;
  }
